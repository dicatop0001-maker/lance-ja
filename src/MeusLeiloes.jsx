      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div className="ml-grid-topo">
          ...
          <div style={{ background: 'white', borderRadius: '20px', padding: 'clamp(16px, 4vw, 30px)', textAlign: 'center' }}>
            ...
            <img src="/logo-conecty.png" alt="Zap Bairro" style={{ width: 'clamp(160px, 50vw, 280px)', height: 'auto', margin: '0 auto 12px auto', display: 'block', borderRadius: '10px', boxShadow: '0 2px 8px rgba(0,0,0,0.12)' }} />
            {qrCodeUrl && (
              <div>
