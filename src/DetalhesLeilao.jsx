  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f5f5f5' }}>
      <div style={{ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', padding: '20px', color: 'white' }}>
        ...
        <span style={{ fontSize: '24px', fontWeight: 'bold' }}>Detalhes do Leilão</span>
      </div>
        ...
        <div>
          ...
          <div style={{ background: 'white', borderRadius: '20px', padding: '30px', marginTop: '20px' }}>
            ...
            <div style={{ borderTop: '1px solid #e0e0e0', paddingTop: '20px' }}>
              ...
              <div style={{ marginBottom: '10px' }}><strong>Localização:</strong> {auction.neighborhood}, {auction.city} - {auction.state}</div>
            ...
            {bids.length === 0 ? (
              ...
              <div>{bids.map((bid, i) => (
                <div key={bid.id} style={{ padding: '15px', background: i === 0 ? '#f0f5ff' : '#f9f9f9', borderRadius: '10px', marginBottom: '10px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div>
                    <div style={{ fontWeight: 'bold' }}>{bid.users?.name || bid.users?.email || 'Anônimo'}</div>
